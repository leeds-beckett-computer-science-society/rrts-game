...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'rrts_main.data';
    var REMOTE_PACKAGE_BASE = 'rrts_main.data';
...
Module['FS_createPath']('/', 'shaders', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_rrts_main.data');

    };
    Module['addRunDependency']('datafile_rrts_main.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 33, "filename": "/shaders/vertex.glsl"}, {"start": 33, "audio": 0, "end": 66, "filename": "/shaders/fragment.glsl"}], "remote_package_size": 66, "package_uuid": "9d265c00-230d-4b95-ba70-c0094803a8e7"});
...
var wasmBinaryFile = 'rrts_main.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=23344;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
